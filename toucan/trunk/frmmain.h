...
#define ID_RADIOBUTTONR 10107
#define ID_BACKUPPASS 10108
#define ID_BACKUPPASS2 10109
#define ID_LANGUAGE 10110
/*!
* Compatibility
*/
...
public:
	...
	wxStaticText* m_Backup_Text_1;
	wxTextCtrl* m_Backup_First;
	wxStaticText* m_Backup_Text_2;
	wxTextCtrl* m_Backup_Second;
	...
	wxRadioBox* m_RoutineSecure;
	wxTextCtrl* m_Backup_Pass;
	wxTextCtrl* m_Backup_Pass2;
    wxComboBox* m_Lang;
	public:
	wxString strMain;
