...
#define SWIG_name      "toucan"
#define SWIG_init      luaopen_toucan
#define SWIG_init_user luaopen_toucan_user

#define SWIG_LUACODE   luaopen_toucan_luacode
...
extern "C" {
#endif
static int _wrap_OutputProgress(lua_State* L) {
  int SWIG_arg = 0;
  wxString arg1 ;
  
  SWIG_check_num_args("OutputProgress",1,1)
  if(!lua_isstring(L,1)) SWIG_fail_arg("OutputProgress",1,"wxString");
  arg1 = wxString(lua_tostring(L,1), wxConvUTF8);
  OutputProgress(arg1);
