...
// Copyright:   Copyright (C) 2006 - 2011 Steven Lamerton
...
BEGIN_EVENT_TABLE(frmMain, wxFrame)
    ...
    EVT_COMMAND_SCROLL_THUMBTRACK(ID_BACKUP_RATIO, frmMain::OnBackupRatioChanged)
...
void frmMain::OnAboutClick(wxCommandEvent& WXUNUSED(event)){
	...
	info.SetVersion(wxT("3.1.1-pre.1"));
